...
\hypersetup{
    ...
    pdftitle={CSAF Software Requirement Specification},    % title
    pdfauthor={Ethan Lew},                     % author
    pdfsubject={Control System Analysis Framework},                        % subject of the document
    pdfkeywords={CSAF, Requirements, Controls, Specification, Systems}, % list of keywords
