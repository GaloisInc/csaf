...
def run_experiment(args):
    def env_fn():
        ...
        my_conf = cconf.SystemConfig.from_toml(
            "/home/sdwivedi/csaf_architecture/examples/f16/f16_simple_config.toml")  # "/csaf-system/f16_simple_config.toml")
        ...
        my_env = csys.SystemEnv("autopilot", my_system, corerl=True, blend=0.3)
