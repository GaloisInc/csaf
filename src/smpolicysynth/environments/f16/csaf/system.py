...
class SystemEnv:
    def __init__(self, cname, sys, terminating_conditions=None, corerl=False, blend=0.5):
        ...
        self.blend = blend
        if corerl:
            self.autopilot_model = ModelNative.from_filename("/home/sdwivedi/csaf_architecture/examples/f16/components/autopilot.py", "/home/sdwivedi/csaf_architecture/examples/f16/components/autopilot.toml")
