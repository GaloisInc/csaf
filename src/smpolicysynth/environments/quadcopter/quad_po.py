...
class QuadcopterPO(System):
	...
	def sample_init_state(self):
		...
		for i in range(self.num_tunnels):
			...
			if  t_y0 <= 0.5  or t_y1 >= 10.0 :
				...
				#print("Tunnel", increasing)

			#print("Floor", floor_min, floor_max)
			#print("Roof", roof_min, roof_max)
	...
	def plot_init(self, state):
		...
		for tunnel in tunnels:
			...
			pl.plot([t_x0, t_x0], [t_y1, 12.0], "k", alpha=0.1)
			pl.plot([t_x1, t_x1], [t_y1, 12.0], "k", alpha = 0.1)
