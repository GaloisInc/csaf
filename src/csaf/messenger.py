...
class SerialMessenger:
    ...
    @staticmethod
    def header(topic, time: float = 0.0):
        """csaf ROSmsg header"""
    ...
    def deserialize_message(self, msg_str: bytes, topic: str, time: float):
    ...
    def serialize_message(self, msg: list, topic: str, time: float):
