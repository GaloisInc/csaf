...
class AcasScenario:
    ...
    def abs_to_rel(self, ownship: typing.Sequence[float],
                   intruder: typing.Sequence[float],
                   balloon: typing.Sequence[float]) -> typing.Tuple[float, float, float, float]:
        """
